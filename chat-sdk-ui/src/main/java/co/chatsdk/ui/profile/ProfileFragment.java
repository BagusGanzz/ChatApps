...
//            })));
...

            {
                public void onClick(View arg0) {
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(ProfileFragment.this.getContext());

                    // Setting Dialog Title
                    alertDialog.setTitle("Confirm Delete...");

                    // Setting Dialog Message
                    alertDialog.setMessage("Are you sure you want unfriend this person?");
                    ...
                    alertDialog.setNegativeButton("NO",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,	int which) {
                                    // Write your code here to execute after dialog
//                                    Toast.makeText(getContext(), "Stay Connected with your friend", Toast.LENGTH_SHORT).show();
                                    dialog.cancel();
                                }
                            });
