...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected EditText usernameEditTextReg;
    protected EditText passwordEditTextReg;

    protected TextInputLayout togleUsernameReg;
    protected TextInputLayout toglePasswordReg;
    protected TextInputLayout toglePasswordConf;
    ...
    protected Button btnLogin, btnReg, btnAnonymous, btnTwitter, btnGoogle, btnFacebook, btnRegTogle, btnLoginTogle;
//    protected Button btnResetPassword;
    ...
    protected void initViews () {
        ...
        btnRegTogle = findViewById(R.id.chattogle_sdk_btn_register);
        btnLoginTogle = findViewById(R.id.chattogle_sdk_btn_login);
        usernameEditText = findViewById(R.id.chat_sdk_et_username);
        passwordEditText = findViewById(R.id.chat_sdk_et_password);
        toglePasswordConf = findViewById(R.id.passConf);
...
//        btnResetPassword.setVisibility(ChatSDK.config().resetPasswordEnabled ? View.VISIBLE : View.INVISIBLE);
    ...
    public void buttonclickRegis(View view){
        btnLogin.setVisibility(View.GONE);
        btnReg.setVisibility(View.VISIBLE);

        toglePasswordConf.setVisibility(View.VISIBLE);
    }
    ...
    public void buttonclickLogin(View view){
        ...
        toglePasswordConf.setVisibility(View.GONE);
    }
